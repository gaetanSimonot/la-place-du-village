...
// Le bundle AdminDashboard ne se télécharge QUE quand ce composant se rend
// c'est-à-dire uniquement après validation du PIN
...
export default function AdminAccess() {
  ...
  // Session valide → déverrouille directement sans modal
  useEffect(() => {
  ...
  // Admin déverrouillé → charge et affiche le dashboard
