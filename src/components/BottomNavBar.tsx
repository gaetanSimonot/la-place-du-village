...
/**
 * Hauteur de la barre, hors encoche basse (le padding safe-area s'ajoute).
 *
 * Elle était recopiée à la main dans une dizaine d'écrans — et déjà avec
 * deux valeurs différentes : la carte comptait 62, tout le reste 64. Toute
 * barre fixe posée au-dessus de la nav, tout fond de conversation et les
 * points d'accroche de la feuille de la carte s'y accrochent : on la lit
 * ici, on ne la retape pas.
 */
        ...
        if (t.plus) {
          return (
            ...
            >
              ...
              <span style={{ fontSize: 10.5, fontWeight: 700, color: 'var(--nav-actif, #2D5A3D)' }}>Ajouter</span>
            </button>
          )
        }
