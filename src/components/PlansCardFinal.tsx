  ...
  return (
    <div style={{ padding: '12px 16px 0' }}>
      <div style={{ position: 'relative', background: 'linear-gradient(135deg, #FFF7EE 0%, #FFEAD8 100%)', border: '1px solid #F2D3BC', borderRadius: 14, overflow: 'hidden' }}>
        <button onClick={onClick} style={{ width: '100%', background: 'transparent', border: 'none', cursor: 'pointer', textAlign: 'left', display: 'flex', alignItems: 'center', gap: 11, padding: '11px 12px', paddingRight: onDismiss ? 34 : 12, fontFamily: 'var(--font-body), sans-serif' }}>
