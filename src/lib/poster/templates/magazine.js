...
export async function render({ d, W, H, fx, sources }) {
  ...
  return Box(
    ...
    Box({ position: 'absolute', left: M, right: M, bottom: M, display: 'flex', flexDirection: 'column' },
      ...
      d.description ? Text({ fontFamily: 'Poppins', fontWeight: 400, fontSize: 2.5 * u, lineHeight: 1.4, color: 'rgba(255,255,255,0.82)', marginTop: 2.4 * u, maxWidth: '88%' }, d.description) : null,
