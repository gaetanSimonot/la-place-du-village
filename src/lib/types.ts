...
export interface AppNotification {
  ...
  target_type: 'producer' | 'event' | 'etablissement' | 'claim' | 'promotion' | 'annonce' | 'conversation' | 'support_conversation' | 'journal' | 'article' | 'friendship' | null
  lu: boolean
  created_at: string
}
